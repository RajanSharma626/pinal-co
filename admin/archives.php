...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == 'delete') {
        ...
        $delete = "DELETE FROM `archieve` WHERE `id`='$id'";
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Archives</h4>

                                <div>
                                    <a href="add-archives" class="btn btn-success" id="addproduct-btn"> Add
                                        Archieve</a>
                                </div>
                    ...
                    <div class="row" data-masonry='{"percentPosition": true }'>
                        <?php
                        $sql = mysqli_query($conn, "SELECT * FROM `archieve` ORDER BY `id` DESC");
                            ...
                            <div class="col-xxl-4 col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <img src="../assets/images/archives/<?php echo $row['cover']?>" alt=""
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <div>
                                                <a href="add-archives?id=<?php echo $row['id'] ?>"
