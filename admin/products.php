                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="add-product" class="btn btn-success" id="addproduct-btn"> Add
                                        Products</a>
                                </div>
                            ...
                            <div class="col-xxl-4 col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <img src="../assets/images/product/<?php echo $row['img']?>" alt=""
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <div>
                                                <a href="add-product?id=<?php echo $row['id'] ?>"
