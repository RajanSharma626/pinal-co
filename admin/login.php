                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-2">
                        <a class="navbar-brand mb-2 mb-sm-0" href="index.html">
                            <img src="assets/images/favicons/logo.png" class="card-logo card-logo-dark" alt="logo dark"
                                width="200">
                    ...
                    <div class="col-lg-6">
                        <div class="auth-card mx-lg-3">
                            ...
                            <div class="card border-0 mb-0">
                                ...
                                <div class="card-body">
                                    <p class="text-muted fs-15">Sign in to continue to Pinal & Co.</p>
                                    <div class="p-2">
                                        <form method="post">
                        ...
                        <div class="col-lg-12">
                            <div class="text-center">
                                <p class="mb-0 text-muted">©
                                    <script>document.write(new Date().getFullYear())</script> WebKye.in
                                </p>
                            </div>
                        </div>
                    </div>
